...
export default function CertificadoLaboralForm() {
    return (
        <>        
            <Container width="lg" sx={{ mt: 4, mb: 4 }}>                            
                <Grid item xs={12}>
                    <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                        <div className="col-sm-7 col-md-6 col-lg-6 text-center">
                            <h3><i className="fas fa-receipt"></i>    Certificado Laboral</h3>  
                        </div>
                    </Paper>
                </Grid>  
                <hr/>               
