...
import { addPermiso } from '../../service/API';
            ...
            <Grid item xs={12}>
                <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>                                        
                    <FormGroup className={classes.container}>
                        <Typography className='text-center' variant="h4">Solicitar permiso</Typography>
                        <br/>
                        <FormControl>
                        ...
                        <div className='text-end'>
                            <Button variant="contained" color='primary' style={{marginRight: 20}} onClick={()=> addPermisoDetails()}>Crear</Button>
